...
public class Lunar {
    ...
    public static SimpleDateFormat smallFormat = new SimpleDateFormat("yyyyMMdd");
    public static SimpleDateFormat monthFormat = new SimpleDateFormat("MMdd");
    ...
    public static void main(String[] args) throws ParseException {
        ...
        today.setTime(chineseDateFormat.parse("2021年9月22日"));
        today.setTime(smallFormat.parse("19990921"));
        // 加载自定义日期
        Lunar lunar = new Lunar(today);
        //计算输出阴历年份
        System.out.print(lunar.cyclical() + "年");
        //计算输出阴历日期
        System.out.println(lunar);
        //计算输出属相
        System.out.println(lunar.animalsYear());
        //输出阳历日期
        System.out.println(new java.sql.Date(today.getTime().getTime()));
        //计算输出星期几
        System.out.println("星期" + lunar.getChinaWeekdayString(today.getTime().toString
                ().substring(0, 3)));
    }
}
